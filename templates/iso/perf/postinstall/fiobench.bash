...
fio --loops=$LOOPS --size=$SIZE --filename="$TARGET/.fiomark.tmp" \
  --stonewall --ioengine=libaio --direct=1 --zero_buffers=$WRITEZERO \
  --output-format=json --output "$TARGET/.fiomark.txt" \
